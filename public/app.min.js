...
+"</span> &ndash; &copy; 2021 P<span class=\"w3-hide-small\">atrick </span>Cardona \n -\n      <span class=\"w3-hide-small\">Hébergement&nbsp;: </span><a title=\"site hébergeur\" \n      href=\"https://pages.github.com/\" \n      target=\"_blank\" rel=\"noreferrer noopener\" style=\"text-decoration: none\">\n      gh-pages\n      </a>\n    </footer>";},"useData":true});},{"hbsfy/runtime":23}],31:[function(require,module,exports){exports.masquer_aide=function(){$("#aide").hide();};exports.afficher_aide=function(){$("#aide").show();};exports.alterner_section_aide=function(id){let section=document.getElementById(id);if(section.className.indexOf("w3-show")==-1){section.className+=" w3-show";}else{section.className=section.className.replace(" w3-show","");}};},{}],32:[function(require,module,exports){const Popup=require('./messageModule.js').Popup;const popup=new Popup();var exercice={titre:""};exercice.init=function(){this.titre=document.getElementById("titre").textContent;return true;};exports.exercice=exercice;},{"./messageModule.js":35}],33:[function(require,module,exports){exports.filtrer=function(IDListe,motif){let filtre,ul,li,a,i,txtValue;filtre=motif.toUpperCase();ul=document.getElementById(IDListe);li=ul.getElementsByTagName("li");for(i=0;i<li.length;i++){a=li[i].getElementsByTagName("a")[0];txtValue=a.textContent||a.innerText;if(txtValue.toUpperCase().indexOf(filtre)>-1){li[i].style.display="";}else{li[i].style.display="none";}}}},{}],34:[function(require,module,exports){const{exercice}=require("./exerciceModule");const{Popup}=require("./messageModule");var ojmemor={};var popup=new Popup;ojmemor.init=function(){this.app_name="ejMemor";this.theme="";this.auteur="";this.series=[];this.code="";};ojmemor.enregistrer_les_parametres=function(e){let bonneSaisie=true;$("*[id*=edito_jmemor]").each(function(){if($(this).val().length==0){bonneSaisie=false;popup.afficherMessage("1");return false;}});if(bonneSaisie==true){ojmemor.theme=$("#edito_jmemor_0").val();ojmemor.auteur=$("#edito_jmemor_1").val();ojmemor.consigne=$("#edito_jmemor_2").val();$("#etape_Action_Saisie_Serie").show();$("#etape_Action_Nouveau").hide();}
e.preventDefault();};var ocarte={};ocarte.init=function(){this.paire=[];this.serie=[];};ocarte.ajouter_carte=function(){var bonneSaisie=true;$("*[id*=carte_]").each(function(){if($(this).val().length==0){bonneSaisie=false;popup.afficherMessage("1");return false;}});if(bonneSaisie==true){ocarte.paire=[];ocarte.paire=[$("#carte_1").val(),$("#carte_2").val()];ocarte.serie.push(ocarte.paire);ocarte.tableau();ocarte.actionsTableauCartes();$(".carte tr:nth-child(even)").addClass("gris");$("*[id*=carte_]").each(function(){$(this).val("");});$("#cartes_saisies").show();}};ocarte.tableau=function(){var tab="<table class='carte'>";tab+="<thead><tr><th>#</th><th>Recto</th><th>Verso</th><th class='action' colspan='2'>Actions</th></tr></thead>";tab+="<tbody>";if(this.serie.length>0){for(var i=0;i<this.serie.length;i++){tab+="<tr id='ligne_"+i+"'>";tab+="<td>"+(i+1)+"</td>";tab+="<td>"+this.serie[i][0]+"</td>";tab+="<td>"+this.serie[i][1]+"</td>";tab+="<td class='editer_carte'><i class='icon-editer'></i></td>";tab+="<td class='supprimer_carte'><i class='icon-corbeille'></td>";tab+="</tr>";}}
tab+="</tbody></table>";$("#cartes_saisies").html(tab);}
ocarte.actionsTableauCartes=function(){$("td.editer_carte").on("click",function(){var cle=$(this.parentNode).attr("id");var x=parseInt(cle.charAt(6));ocarte.editeCarte(x);ocarte.tableau();ocarte.actionsTableauCartes();});$("td.editer_carte").on("mouseover",function(){$(this).css("cursor","pointer");});$("td.editer_carte").on("mouseout",function(){$(this).css("cursor","default");});$("td.supprimer_carte").on("click",function(){var cle=$(this.parentNode).attr("id");var x=parseInt(cle.charAt(6));ocarte.supprimeCarte(x);ocarte.tableau();ocarte.actionsTableauCartes();});$("td.supprimer_carte").on("mouseover",function(){$(this).css("cursor","pointer");$(this).addClass("rouge");});$("td.supprimer_carte").on("mouseout",function(){$(this).css("cursor","default");$(this).removeClass("rouge");});};ocarte.supprimeCarte=function(_idx){ocarte.serie.splice(_idx,1);}
ocarte.editeCarte=function(_idx){var recto=this.serie[_idx][0];var verso=this.serie[_idx][1];$("#carte_1").val(recto);$("#carte_2").val(verso);this.serie.splice(_idx,1);};ojmemor.enregistrer_cet_exercice=function(){if(ocarte.serie.length==0){popup.afficherMessage("2");return false;}
if(ojmemor.code!=undefined){delete ojmemor.code;}
ojmemor.genereCode(ocarte.serie);$("#zonecode").val(ojmemor.code);$("#etape_Action_Saisie_Serie").hide();$("#etape_Action_Code").show();ocarte.serie=new Array();$("#cartes_saisies").html("<p>...</p>");};ojmemor.toJSON=function(_obj){return obj_json=JSON.stringify(_obj);};ojmemor.genereCode=function(_serie){for(var i=0;i<_serie.length;i++){ojmemor.series.push({"ques":_serie[i][0],"ans":_serie[i][1]});}
var code=ojmemor.toJSON(ojmemor.series);ojmemor.code="{ \"app_name\": \""+ojmemor.app_name+"\", \"prof\": \""+ojmemor.auteur+"\", \"titre\": \""+ojmemor.theme+"\", \"consigne\": \""+ojmemor.consigne+"\","
ojmemor.code+="\"series\": "+code+"}"};ojmemor.selectionner_le_code=function(){document.getElementById("zonecode").select();};exports.ojmemor=ojmemor;exports.ocarte=ocarte;},{"./exerciceModule":32,"./messageModule":35}],35:[function(require,module,exports){const infos=require('../../../static/config/popups.json').infos;class Popup{constructor(msgid='000'){this.msgid=msgid;this.message="Un message...";this.titre="Titre";}}
Popup.prototype.preparer=function(msgid){this.msgid=msgid;let info=infos[msgid];this.titre=info.titre;this.message=info.contenu;};Popup.prototype.afficherMessage=function(msgid){this.preparer(msgid);$("#titre_message").html(this.titre);$("#contenu_message").html(this.message);$("#notification").show();};exports.Popup=Popup;},{"../../../static/config/popups.json":60}],36:[function(require,module,exports){exports.derouler_navigation=function(){$("#menu_gauche").show();};exports.refermer_navigation=function(){$("#menu_gauche").hide();};},{}],37:[function(require,module,exports){exports.afficheRubrique=function(evt,nomRubrique){let i,rubriques,tablinks;rubriques=document.getElementsByClassName("rubrique");for(i=0;i<rubriques.length;i++){rubriques[i].style.display="none";}
...
$('#'+nomRubrique).show();evt.currentTarget.className+=" triadic";return true;};},{}],38:[function(require,module,exports){"use strict";const versionApp=require('../package.json').version;const app_name=require('../package.json').name;const description=require('../package.json').description;const origine_logo=require('../static/config/credit.json').origine;const url_logo=require('../static/config/credit.json').url;const credit_logo=require('../static/config/credit.json').credit;const MSG=require('../static/config/messages.json').msg;window.afficheRubrique=require('./lib/scripts/ongletModule.js').afficheRubrique;window.ojmemor=require('./lib/scripts/generateur_01.js').ojmemor;window.ocarte=require('./lib/scripts/generateur_01.js').ocarte;window.afficher_aide=require('./lib/scripts/aideModule.js').afficher_aide;window.masquer_aide=require('./lib/scripts/aideModule.js').masquer_aide;window.alterner_section_aide=require('./lib/scripts/aideModule.js').alterner_section_aide;window.filtrer=require('./lib/scripts/filtre.js').filtrer;window.derouler_navigation=require('./lib/scripts/navigation.js').derouler_navigation;window.refermer_navigation=require('./lib/scripts/navigation.js').refermer_navigation;const Handlebars=require('hbsfy/runtime');const Navigo=require('navigo/lib/navigo');const chibi=require('chibijs/chibi');Handlebars.registerHelper("capitalisePremiereLettre",function(sChaine){if(typeof sChaine==='string'){return sChaine.charAt(0).toUpperCase()+sChaine.slice(1);}
return null;});Handlebars.registerHelper('encodeChaine',function(chaine){return new Handlebars.SafeString(chaine);});Handlebars.registerHelper('typeFormulaireTexte',function(chaine){if(chaine=="texte"){return true;}else{return false;}});const menuTemplate=require("./menus/menuTemplate.hbs");const menuExerciceTemplate=require("./menus/menuExerciceTemplate.hbs");const menuListeTemplate=require("./menus/menuListeTemplate.hbs");Handlebars.registerPartial("apropos",require("./composants/aproposTemplate.hbs"));Handlebars.registerPartial("licence",require("./composants/licenceTemplate.hbs"));Handlebars.registerPartial("prise_en_main",require("./aides/aidePriseEnMain.hbs"));const erreurTemplate=require("./pages/erreurTemplate.hbs");const accueilTemplate=require("./pages/accueilTemplate.hbs");const listeTemplate=require("./pages/listeTemplate.hbs");const accueilExerciceTemplate=require("./pages/accueilExerciceTemplate.hbs");const exerciceTemplate_01=require("./pages/exerciceTemplate_01.hbs");const consigneExerciceTemplate=require("./pages/consigneExerciceTemplate.hbs");const aideTemplate=require("./pages/aideTemplate.hbs");const piedDePageTemplate=require("./composants/piedTemplate.hbs");const notificationTemplate=require("./composants/notificationTemplate.hbs");const zone_notification=notificationTemplate();window.addEventListener("load",()=>{const menu=$("#menu");const app=$("#app");const aide=$("#aide");const notification=$("#notification");const piedDePage=piedDePageTemplate({"version":versionApp});const dataMenuAccueil=require("../static/config/menu_accueil.json").menu;const menuAccueil=menuTemplate(dataMenuAccueil);const dataMenuListe=require("../static/config/menu_liste.json").menu;const dataMenuAide=require("../static/config/menu_aide.json").menu;const menuAide=menuTemplate(dataMenuAide);const dataMenuAccueilExercice=require("../static/config/menu_accueil_exercice.json").menu;const dataMenuExercice=require("../static/config/menu_exercice.json").menu;const dataMenuConsigneExercice=require("../static/config/menu_consigne_exercice.json").menu;let moduleJSONdata=require("../static/config/apropos.json");let rubriquesJSONdataApropos=require("../static/config/rubriques_apropos.json").rubriques;let modeleApropos={"app_name":app_name,"description":description,"module":moduleJSONdata,"rubs":rubriquesJSONdataApropos,"version":versionApp,"credit":credit_logo,"url":url_logo,"origine":origine_logo};let dataLicence=require("../static/config/licence.json").licence;let rubriquesJSONdataLicence=require('../static/config/rubriques_licence.json').rubriques;let texte_page_1=dataLicence.pages[0].texte;let texte_page_2=dataLicence.pages[1].texte;let now=new Date();let actuel=now.getFullYear();let modeleLicence={"debut":dataLicence.debut,"actuel":actuel,"auteur":dataLicence.auteur,"texte_page_1":texte_page_1,"texte_page_2":texte_page_2,"rubs":rubriquesJSONdataLicence};let contenu={"modeleApropos":modeleApropos,"modeleLicence":modeleLicence}
const SommaireAide=aideTemplate(contenu);var root="/"+app_name+"/";var useHash=true;var hash='#!';var router=new Navigo(root,useHash,hash);router.notFound(function(){const html=erreurTemplate({couleur:"yellow",titre:"Erreur 404 - Page introuvable !",message:"Ce chemin n\'existe pas."});menu.html(menuAccueil);app.html(html);});router.on({"aide":function(){app.html(SommaireAide);menu.html(menuAide);},"liste/exercices":function(){let JSONdata=require("../static/config/liste_exercices.json");let contenu={"info":JSONdata,"exercice":"exercice","cible":"exercice",};let html=listeTemplate(contenu);dataMenuListe.exercice='exercice';const menuListe=menuListeTemplate(dataMenuListe);menu.html(menuListe);app.html(html);},"choix/exercice/:id":function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice="exercice";contenu.cible="exercice";contenu.consigne=data.consigne;let html=accueilExerciceTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuAccueilExercice.did=params.id;dataMenuAccueilExercice.exercice="exercice";dataMenuAccueilExercice.actionsMobile=[].slice.call(dataMenuAccueilExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuAccueilExercice);menu.html(menuD);},"effectuer/exercice/:id":function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice="exercice";contenu.app_name=data.app_name;contenu.titre=data.titre;ojmemor.init();ocarte.init();let html;switch(contenu.did){case"01":html=exerciceTemplate_01(contenu);break;default:html="<p>Erreur, contenu.did vaut : "+contenu.did+"</p>";}
app.html(html);notification.html(zone_notification);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuExercice.did=params.id;dataMenuExercice.exercice="exercice";dataMenuExercice.actionsMobile=[].slice.call(dataMenuExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuExercice);menu.html(menuD);},"consigne/exercice/:id":function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice="exercice";contenu.cible="exercice";contenu.consigne=data.consigne;let html=consigneExerciceTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuConsigneExercice.did=params.id;dataMenuConsigneExercice.exercice="exercice";dataMenuConsigneExercice.actionsMobile=[].slice.call(dataMenuConsigneExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuConsigneExercice);menu.html(menuD);},"":function(){let html=accueilTemplate({"bienvenue":MSG.bienvenue});app.html(html);app.htmlAppend(piedDePage);menu.html(menuAccueil);menu.show();sessionStorage.clear();}}).resolve();});},{"../package.json":25,"../static/config/apropos.json":49,"../static/config/credit.json":50,"../static/config/licence.json":51,"../static/config/liste_exercices.json":52,"../static/config/menu_accueil.json":53,"../static/config/menu_accueil_exercice.json":54,"../static/config/menu_aide.json":55,"../static/config/menu_consigne_exercice.json":56,"../static/config/menu_exercice.json":57,"../static/config/menu_liste.json":58,"../static/config/messages.json":59,"../static/config/rubriques_apropos.json":61,"../static/config/rubriques_licence.json":62,"./aides/aidePriseEnMain.hbs":26,"./composants/aproposTemplate.hbs":27,"./composants/licenceTemplate.hbs":28,"./composants/notificationTemplate.hbs":29,"./composants/piedTemplate.hbs":30,"./lib/scripts/aideModule.js":31,"./lib/scripts/filtre.js":33,"./lib/scripts/generateur_01.js":34,"./lib/scripts/navigation.js":36,"./lib/scripts/ongletModule.js":37,"./menus/menuExerciceTemplate.hbs":39,"./menus/menuListeTemplate.hbs":40,"./menus/menuTemplate.hbs":41,"./pages/accueilExerciceTemplate.hbs":42,"./pages/accueilTemplate.hbs":43,"./pages/aideTemplate.hbs":44,"./pages/consigneExerciceTemplate.hbs":45,"./pages/erreurTemplate.hbs":46,"./pages/exerciceTemplate_01.hbs":47,"./pages/listeTemplate.hbs":48,"chibijs/chibi":1,"hbsfy/runtime":23,"navigo/lib/navigo":24}],39:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,alias5=container.lambda,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(1,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":0},"end":{"line":38,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],41:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <a href=\""
...
+alias4(((helper=(helper=lookupProperty(helpers,"titre")||(depth0!=null?lookupProperty(depth0,"titre"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"titre","hash":{},"data":data,"loc":{"start":{"line":16,"column":10},"end":{"line":16,"column":19}}}):helper)))
+" d'exercice pour "
+alias4(((helper=(helper=lookupProperty(helpers,"app_name")||(depth0!=null?lookupProperty(depth0,"app_name"):depth0))!=null?helper:alias2),(typeof helper===alias3?helper.call(alias1,{"name":"app_name","hash":{},"data":data,"loc":{"start":{"line":16,"column":36},"end":{"line":16,"column":48}}}):helper)))
+"</h3>\n    </div>\n  </div>\n\n<div id='etape_Action_Nouveau'>\n\n<h2>Configuration</h2>\n  <form id='infos_editoriales_ejmemor'>\n  <fieldset><legend>Données éditoriales obligatoires&nbsp;</legend>\n  <table>\n    <tr>\n      <td><label for='edito_jmemor_0'>Thème:</label></td>\n      <td><input type='text' id='edito_jmemor_0' name='theme_jmemor' value='' placeholder='Thème de la série' /></td>\n    </tr>\n    <tr>\n      <td><label for='edito_jmemor_1'>Auteur:</label></td>\n      <td><input type='text' id='edito_jmemor_1' name='auteur' value='' placeholder=\"Auteur de la série\" /></td>\n    </tr>\n    <tr>\n       <td><label for='edito_jmemor_2'>Consigne:</label></td>\n      <td><input type='text' id='edito_jmemor_2' name='consigne' value='' placeholder=\"Votre consigne...\" /></td>\n  </tr>\n  </table>\n  </fieldset>\n  <button onclick=\"ojmemor.enregistrer_les_parametres(event);\">Étape suivante</button>\n  </form>\n</div>\n\n<div id='etape_Action_Saisie_Serie' class=\"zone_masquee\">\n    <h2>Saisie des cartes à mémoriser</h2> \n   <form><fieldset><legend>Nouvelle carte : </legend>\n   <table><tr><td><label for='carte_1'>Recto :</label></td>\n   <td><input type='text' name='recto' id='carte_1' value='' /></td></tr>\n   <tr><td><label for='carte_2'>Verso :</label></td>\n   <td><input type='text' name='verso' id='carte_2' value='' /></td></tr></table>\n   <button onclick=\"ocarte.ajouter_carte();\">Ajouter cette carte</button>\n   </fieldset>\n   <fieldset><legend>Cartes ajoutées à la série : </legend>\n   <div id='cartes_saisies'>Aucune carte saisie.</div>\n   <button onclick=\"ojmemor.enregistrer_cet_exercice();\">Générer le code de cet exercice</button>\n    </fieldset></form>\n  </div>\n\n<div id='etape_Action_Code' class=\"zone_masquee\">\n  <h2 id='titre10'><img src='./static/images/json.png' width='100px' align='left' alt='Données JSON' />Données de l'exercice</h2>\n  <div id='enregistrement'>\n   <button onclick=\"ojmemor.selectionner_le_code();\">Sélectionner le code</button><br />\n   <textarea id='zonecode' cols='60' rows='10'></textarea>\n  </div>\n</div>\n\n</div>";},"useData":true});},{"hbsfy/runtime":23}],48:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths){var alias1=container.lambda,alias2=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
